...
import org.droidplanner.fragments.AG_WaypointProgressFragment;
...
public class FlightActivity extends DrawerNavigationUI implements
	...
	private void toggleCommFlightFragment() {
		Fragment prev = fragmentManager
				.findFragmentByTag("fragment_wp_progress");
		if (prev != null) {
			fragmentManager.beginTransaction().remove(prev);
		}

		AG_WaypointProgressFragment wpProgress = AG_WaypointProgressFragment.newInstance(drone);
		
		wpProgress.show(fragmentManager, "fragment_wp_progress");
	}
